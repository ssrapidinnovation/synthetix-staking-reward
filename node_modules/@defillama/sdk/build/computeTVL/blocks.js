...
exports.getCurrentBlocks = exports.getBlocks = exports.getChainBlocks = exports.chainsForBlocks = void 0;
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 2:
                                        ...
                                        _a = chainBlocks;
                                        _b = chain;
                                        return [4 /*yield*/, index_1.lookupBlock(timestamp, {
                                                chain: chain,
                                            }).then(function (block) { return block.block; })];
                                    case 3:
                                        _a[_b] = _c.sent();
                                        return [3 /*break*/, 6];
                                    case 4:
...
function getBlocks(timestamp) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, ethBlock, chainBlocks;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.all([index_1.lookupBlock(timestamp), getChainBlocks(timestamp)])];
                case 1:
...
function getCurrentBlocks() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, lastBlockNumber, block, chainBlocks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = general_1.getProvider("ethereum");
                    return [4 /*yield*/, provider.getBlockNumber()];
                case 1:
                    lastBlockNumber = _a.sent();
                    return [4 /*yield*/, provider.getBlock(lastBlockNumber - 5)];
                case 2:
                    block = _a.sent();
                    return [4 /*yield*/, getChainBlocks(block.timestamp)];
                case 3:
                    chainBlocks = _a.sent();
